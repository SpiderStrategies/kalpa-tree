...
Dnd.prototype._createTraveler = function (d, i, node) {
  ...
  // Emit dndstart passing the node we're moving, the traveler, and the data bound to the moving node
  this.tree.emit('dndstart', node, this.traveler.node(), d)
...
Dnd.prototype._escape = function (node) {
...
Dnd.prototype._end = function (d, node) {
  ...
  // Emit dndstop passing the node we're moving, the traveler, and the data bound to the moving node
  this.tree.emit('dndstop', node, this.traveler.node(), d)
